...
<div class="container">
	<form:form action="searchcat" method="post">
		...
		<center><h3>LIST OF DELETED CATEGORIES</h3></center>
		<br>
...
<table width="50%" class="table table-hover">
	<tr>
		...
		<tr>
			...
			<td>
            <form:form action="retrivedata?key=${category.catid}" method="post">
        <div class="form-group">	
        
           <button type="submit" class="btn btn-success">RETRIVE THIS INFO</button></div>
  </form:form></td>
		</tr>	</c:forEach>
</table></div>
